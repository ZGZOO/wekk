...
//Variable names:               1. ORIGINAL_DIMENSION_SIZE (static final, class scope), the size of the 2D array
//							   2. NUMBER_OF_SHIPS (static final, class scope), the number of the ships
//							   3. NUMBER_OF_GUESSES (static final, class scope), the number of the chances to guess
//							   4. shipGrid [][] (int), the 2D array of the battle place of the ship
//							   5. hitGrid [][] (int), the 2D array of the player's battle place

public class PlayGame {
	static final int ORIGINAL_DIMENSION_SIZE = 10;
	static final int NUMBER_OF_SHIPS = 5;
	static final int NUMBER_OF_GUESSES = 25;
	
	public static void main( String [] args) {
		int [][] shipGrid = new int[ORIGINAL_DIMENSION_SIZE][ORIGINAL_DIMENSION_SIZE];
		int [][] hitGrid = new int[ORIGINAL_DIMENSION_SIZE][ORIGINAL_DIMENSION_SIZE];
		
		GameMethods.displayRules();
		do {
			GameMethods.fillShipGrid(shipGrid, NUMBER_OF_SHIPS);
			GameMethods.fillHitGrid(hitGrid);
			GameMethods.playBattleship(shipGrid, hitGrid, NUMBER_OF_SHIPS, NUMBER_OF_GUESSES);
		}while(GameMethods.wantsToContinue("Want to play another game?"));
	}
}
